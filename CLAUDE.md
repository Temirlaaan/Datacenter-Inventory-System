...
- `docs/sprint-10.md` — Sprint 10 plan (delivered)
...
- `docs/cron.md` — consolidated operator guide for all three host-cron jobs (backup + idempotency cleanup + restore validation; Sprint 10 Task 0).
